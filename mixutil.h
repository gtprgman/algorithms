...
namespace mix {
	...
	public:
		static const bool Result = (sizeof(type_) != sizeof(mix::data::Bucket));
	};
	...
	public:
		typedef typename resultType* ptrType;
	};
